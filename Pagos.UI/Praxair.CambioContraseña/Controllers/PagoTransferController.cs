...
{
    public class PagoTransferController : Controller
    {
        private const int IdPago = 4;
        // GET: PagoTransfer
        ...
        public ActionResult RealizarPagoTransfer(string correo, int tipoUsuario, string tipoId, string identificacion, string banco, string observacion, string monto, string referencia)
        {
            bool salida = false;
            salida = Praxair.Negocio.BackPagosEnLinea.Servicios.RealizarPagoTrasnfer(correo, tipoUsuario, tipoId, identificacion, banco, observacion, monto, referencia);
